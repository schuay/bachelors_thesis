...
The \emph{simavr} \ac{VCD} implementation uses a combination of cycle timers
and \acp{IRQ} to track signal\footnote{
%
In \emph{simavr}, each tracked signal is actually an \ac{IRQ}.
%
...
The actual core definitions used by \emph{simavr} are located in the
...
This concludes our tour of the \emph{simavr} core modules. You should now have a
good idea of how \emph{simavr} internals work together and complement each
