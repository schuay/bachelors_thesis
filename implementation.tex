...
upon completion of 320 ns data delay time. Note that display read data first passes an
...
This component simulates a 2x16 hardware \ac{LCD} display based on the HD44780
chip \cite{hitachi01, samsung02, winstar02}.
...
\cite{maxim02}
Furthermore,
we've encountered difficulties caused by the implementation of \ac{IO} pin levels
...
is set to input mode. Unfortunately, we had to use fairly methods to counteract
that.
